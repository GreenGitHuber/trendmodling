...
def read_same_day(yearstep,year,m_str, d_str):
    ...
    return occupancy[288:,:],speed[288:,:],flow[288:,:]
...
np.savez('../data/17_12_pems_speed_occupancy_5min.npz', speed=speed, occupancy=occupancy,flow = flow)
