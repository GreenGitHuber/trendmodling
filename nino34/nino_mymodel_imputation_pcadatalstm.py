...
np.random.seed(7)
with open(r"../../data/nino34imputation/ppca_my_imputation005.txt", encoding="utf-8") as f:
    d=json.load(f)
m = flatten(d)
data= np.array(d)
pca_obj = PCA(data,3)
...
plt.close()
# #
# mre: 0.003474475493423997
# mae: 0.09381595823463061
# rmse: 0.11970232841722275