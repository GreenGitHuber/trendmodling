...
plt.plot(realpredict_y,label='Predicted line')
plt.plot(real_y,label='Excepted line')
plt.show()
plt.close()

plt.plot(data,label='Excepted line')
plt.plot(([None for _ in range(train_size)] + [x for x in realpredict_y]),label='Predicted line')
