...
csv_reader = csv.reader(open('../pems/d05_text_station_5min_2018_02_01.txt'))
...
np.savez('../data/pems_speed_occupancy_5min_upflow.npz', speed=speed, occupancy=occupancy,flow = flow)
